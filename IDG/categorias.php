...
<div class = "container">
    ...
    <div class="mt-3 d-flex flex-wrap justify-content-around">
        ...
        <?php
$decada = array('1940', '1950', '1960', '1970', '1980', '2000');
for ($i = 0; $i <6 ; $i++) {
?>
        ...
        <a style="width: 278px;" href= "<?php echo $decada[$i]?>.php?id=<?php echo $i;?>"&cat=<?php echo $categorias[$i]['categoria'];?>" class="btn btn-danger">Ver Jogadores do Período</a>
